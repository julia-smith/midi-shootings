...
mymidi = MIDITime(320, 'chords-reversed-50-sus.mid', 12, 4, 4)
...
my_data = [
    ...
    {'event_date': '01-08-2015', 'fatalities': 5.0, 'total': 5.0} #add extra to extend the midi file to the appropriate length (starting in Aug. 2015)
]
